...
/// \brief Make a pipe adapter connecting two different pipes oriented in Z-direction starting from Z=0
Shape PipeAdapter(const PipeEnds& ends, const PipeBlendOpts& opts = PipeBlendOpts{});
}  // namespace mech
}  // namespace ccad
